...
#define N 8
#define Q 195161/*195161//7919//1049//17*/
...
int main(int argc, char** argv) {
  ...
  cs.KeyGen(N, Q);
  ZZ_pX m, m2, md, mm, ct1[2], ct2[2], ctAdd[2], ctProd[3];

  m.SetLength(N);
  m2.SetLength(N);

  m[7] = 0;m[6] = 0;m[5] = 0;m[4] = 1;m[3] = 0;m[2] = 1;m[1] = 0;m[0] = 1;
  cout << "m: " << m << endl;

  m2[7] = 0;m2[6] = 0;m2[5] = 0;m2[4] = 0;m2[3] = 1;m2[2] = 1;m2[1] = 0;m2[0] = 0;
  cout << "m2: " << m2 << endl;
